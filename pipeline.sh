...
genome=$FASTA_FILE
cupcake=$ISOSEQ3_OUTPUT
##==============================================
## files that don't get modified
repeat_lib=$RMODELER_OUTPUT
proteins=$PROTEIN_FILE
##==============================================

#Creating choromosome list
grep "^>" Arabidopsis_thaliana.Col-PEK1.5.fasta | tee chrs.list
sed -i 's/>//g' chrs.list
...
cd /mnt/gs21/scratch/cuttilua/BASF/Col_PEK1.5_assembly_and_annotation/Maker/${i}
